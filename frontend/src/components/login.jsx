...
const clientID =
  "632119173451-99qld8ukl9ori1rvjd1gt5qju31gempa.apps.googleusercontent.com";
const Login = () => {
  ...
  const handleSubmit = async () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setError("");
        setMessage("");
        if (response.data.status !== 200) setError("Invalid information !");
        else {
          setMessage(response.data.message);
          navigate("/home", {
            state: {
              tokenAuth: response.data.tokenAuth,
